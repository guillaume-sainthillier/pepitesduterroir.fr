...
class ZOneColumnBlocks extends Module
{
    ...
    protected function getColumnBlockForm()
    {
        ...
        $product_filter_options = array(
            'query' => array(
                array('id' => $this->ptfeatures, 'name' => $this->trans(
                    'Featured Products',
                    array(),
                    'Modules.ZoneColumnblocks.Admin'
                )),
                array('id' => $this->ptnew, 'name' => $this->trans(
                    'New Products',
                    array(),
                    'Modules.ZoneColumnblocks.Admin'
                )),
                array('id' => $this->ptspecial, 'name' => $this->trans(
                    'Special Products',
                    array(),
                    'Modules.ZoneColumnblocks.Admin'
                )),
                array('id' => $this->ptseller, 'name' => $this->trans(
                    'Best Seller Products',
                    array(),
                    'Modules.ZoneColumnblocks.Admin'
                )),
                array('id' => $this->ptselected, 'name' => $this->trans(
                    'Selected Products',
                    array(),
                    'Modules.ZoneColumnblocks.Admin'
                )),
                array('id' => $this->ptcategory, 'name' => $this->trans(
                    'Products from Category',
                    array(),
                    'Modules.ZoneColumnblocks.Admin'
                )),
        ...
        $product_thumb_options = array(
            'query' => array(
                array('id' => 'top', 'name' => $this->trans(
                    'Top',
                    array(),
                    'Modules.ZoneColumnblocks.Admin'
                )),
                array('id' => 'left', 'name' => $this->trans(
                    'Left',
                    array(),
                    'Modules.ZoneColumnblocks.Admin'
                )),
