...
{block name='category_miniature_item'}
  <section class="subcategory-miniature {if !$subcategory.image}no-image{/if} col-6 col-sm-4 col-md-4 col-lg-3">
    {if $subcategory.image}
      {if isset($subcategory.image.bySize.category_medium)}
        {assign var=thumbnail value=$subcategory.image.bySize.category_medium}
      {else}
        {assign var=thumbnail value=$subcategory.image.medium}
      {/if}
