      ...
      <div class="row">
        ...
        {block name='order_details'}
          <div class="col-12 col-lg-4">
            <div id="order-details" class="light-box-bg mb-3">
              ...
              <ul>
                ...
                {if !$order.details.is_virtual}<li>{l s='Shipping method: %method%' d='Shop.Theme.Checkout' sprintf=['%method%' => $order.carrier.name]} - <em>{$order.carrier.delay}</em></li>{/if}
              </ul>
            </div>
          </div>
        {/block}
  ...
  {block name='customer_registration_form'}
    {if $customer.is_guest}
      <div id="registration-form" class="registration-form mt-4">
        <div class="light-box-bg">
          <h4 class="mb-4">{l s='Save time on your next order, sign up now' d='Shop.Theme.Checkout'}</h4>
