  ...
  <div class="js-address-form">
    ...
    >
      <section class="shipping-address">
        {if !$use_same_address}
          <h5 class="text-info">{l s='Shipping Address' d='Shop.Theme.Checkout'}</h5>
        {/if}
        ...
        {elseif $customer.addresses|count > 0}
          ...
          <p class="add-address">
            <a class="btn btn-secondary btn-small btn-wrap" href="{$new_address_delivery_url}">{l s='add new address' d='Shop.Theme.Actions'}</a>
          </p>
      ...
      {if !$use_same_address}
        <section class="invoice-address">
          <h5 class="text-info">{l s='Your Invoice Address' d='Shop.Theme.Checkout'}</h5>
          ...
          {else}
            ...
            <p class="add-address">
              <a class="btn btn-secondary btn-small btn-wrap" href="{$new_address_invoice_url}">{l s='add new address' d='Shop.Theme.Actions'}</a>
            </p>
          {/if}
        </section>
      {/if}
