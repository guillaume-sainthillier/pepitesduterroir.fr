    ...
    <div class="modal-content">
      ...
      <div class="modal-body text-center">
        ...
        <div class="post-comment-buttons">
          <button type="button" class="btn btn-small btn-secondary refuse-button mx-2" data-dismiss="modal" aria-label="{l s='No' d='Modules.Productcomments.Shop'}">
            {l s='No' d='Modules.Productcomments.Shop'}
          </button>
          <button type="button" class="btn btn-small btn-primary confirm-button mx-2" data-dismiss="modal" aria-label="{l s='Yes' d='Modules.Productcomments.Shop'}">
