...
<div class="currency-selector-wrapper">
  <div class="currency-selector dropdown js-dropdown">
    <div class="desktop-dropdown">
      ...
      <button class="btn-unstyle dropdown-current expand-more" data-toggle="dropdown" data-offset="0,2px" aria-haspopup="true" aria-expanded="false" aria-label="{l s='Currency dropdown' d='Shop.Theme.Global'}">
